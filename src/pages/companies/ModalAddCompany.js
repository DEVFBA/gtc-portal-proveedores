...
function ModalAddCompany({modalAddRecord, setModalAddRecord, dataCountries, updateAddData, pathLogo, ip, autoCloseAlert}) {
    ...
    function addRegister(){
        ...
        fetch(`http://localhost:8091/api/companies/create-company/`, {
            method: "POST",

...
function ModalAddRol({modalAddRecord, setModalAddRecord, ip, autoCloseAlert, updateAddData}) {
    ...
    const [registerShowCust, setregisterShowCust] = React.useState(true);
    ...
    function addRegister(){
        ...
        const catRegister = {
            ...
            pbShowCustomers: registerShowCust,
            pbStatus: registerStatus,
            pvUser: user,
            pvIP: ip
        };
    
        fetch(`${process.env.REACT_APP_API_URI}security-roles/create-rol/`, {
            method: "POST",

...
function ModalUpdateEstatusAgreements({abierto, toggleModalUpdateRecord, record, ip, autoCloseAlert, updateAddData}) {
        // register form
    ...
    function updateRegister(){
        ...
        const catRegister = {
            pSpCatalog: "spCat_Adobe_Sign_Agreement_Status_CRUD_Records",
            pvOptionCRUD: "U",
            pvIdAgreementStatus: updateId,
...
export default ModalUpdateEstatusAgreements;
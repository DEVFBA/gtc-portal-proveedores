...
function ModalUpdateEntityTypes({abierto, toggleModalUpdateRecord, record, ip, autoCloseAlert, updateAddData}) {
        // register form
    ...
    function updateRegister(){
        ...
        const catRegister = {
            pSpCatalog: "spSAT_Cat_Entity_Types_CRUD_Records",
            pvOptionCRUD: "U",

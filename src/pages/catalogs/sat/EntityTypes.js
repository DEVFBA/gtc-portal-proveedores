...
function EntityTypes({dataTable, ip, autoCloseAlert, updateAddData}) {
    ...
    return (
        <div>
            ...
            {/*<ModalAddUser modalAddRecord = {modalAddRecord} setModalAddRecord = {setModalAddRecord}  ip = {ip} autoCloseAlert = {autoCloseAlert} updateAddData = {updateAddData}/> */}

            {/*MODAL PARA MODIFICAR REGISTRO*/}
            {/*<ModalUpdateUser abierto = {modalUpdateRecord} toggleModalUpdateRecord = {toggleModalUpdateRecord} record = {record}  ip = {ip} autoCloseAlert = {autoCloseAlert} updateAddData = {updateAddData}/>*/ }
        </div>
    )

...
function PaymentWays({dataTable, ip, autoCloseAlert, updateAddData}) {
    ...
    return (
        <div>
            ...
            <ModalAddPaymentWays modalAddRecord = {modalAddRecord} setModalAddRecord = {setModalAddRecord}  ip = {ip} autoCloseAlert = {autoCloseAlert} updateAddData = {updateAddData}/>

            {/*MODAL PARA MODIFICAR REGISTRO*/}
            <ModalUpdatePaymentWays abierto = {modalUpdateRecord} toggleModalUpdateRecord = {toggleModalUpdateRecord} record = {record}  ip = {ip} autoCloseAlert = {autoCloseAlert} updateAddData = {updateAddData}/>
        </div>
    )
